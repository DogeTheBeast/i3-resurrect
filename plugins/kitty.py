...
#
#
# def save_kitty_session(pid, config: JSON) -> None:
#     logger.info("Saving Kitty container")
#
# # Need a way to ask user for listen_socket
# # Get container tree (Whatever that means)
# # create session file
# # Add the session file as an arguement to the command stored for programs.json
#
#     listen_socket = get_listen_socket(config["kitty"]["listen_socket"], pid)
